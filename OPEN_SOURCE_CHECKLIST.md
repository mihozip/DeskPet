...
- [x] Added maintainer-approved default cat PNGs with provenance notes in `ASSETS.md`.
...
- [x] Include the maintainer-approved default artwork and document its redistribution status.
