# Artwork and asset notes

## Default DeskPet artwork

The four white-cat PNG files under `Sources/DeskPet/Resources/` are the default artwork shipped with DeskPet.

The project maintainer describes these files as AI-assisted redraws created with visual reference to other artwork. The referenced third-party source image is not included in this repository, and these PNG files are supplied by the maintainer as the project's own default assets.
...
Do not submit artwork, fonts, logos or other media unless you created them or have permission to redistribute them under terms compatible with this public repository. Describe the source and license in the pull request.
